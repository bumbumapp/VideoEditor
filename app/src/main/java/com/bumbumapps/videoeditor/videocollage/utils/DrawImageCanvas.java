package com.bumbumapps.videoeditor.videocollage.utils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < Utils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.bumbumapps.videoeditor.videocollage.BitmapUtils.Utils.width = clgSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.bumbumapps.videoeditor.videocollage.BitmapUtils.Utils.width, imageHeight, true);
