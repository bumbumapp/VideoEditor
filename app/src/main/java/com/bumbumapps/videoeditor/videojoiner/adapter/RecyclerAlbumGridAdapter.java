package com.bumbumapps.videoeditor.videojoiner.adapter;
...
import com.bumbumapps.videoeditor.videojoiner.model.AlbumImages;
...
public class RecyclerAlbumGridAdapter extends BaseAdapter {
    ...
    Context b;
    ImageLoader c;
    int d,height,width,per,exact_heigth,exact_width;
    ...
    public RecyclerAlbumGridAdapter(Context context, int i, ImageLoader imageLoader) {
        ...
        this.height=FileUtils.height;
        this.width=FileUtils.width;
        this.per=this.height/this.d;
        this.exact_width=(this.d*this.exact_width)/this.height;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        holder.tumb=inflate.findViewById(R.id.play_thumb);
        holder.tumb.setVisibility(View.VISIBLE);
        ...
        Picasso.with(this.b).load(uri.toString()).resize(this.exact_width, FileUtils.width/3).into(holder.b);
