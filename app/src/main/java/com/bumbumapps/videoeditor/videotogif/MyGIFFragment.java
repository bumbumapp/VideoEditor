...
import com.bumbumapps.videoeditor.listvideoandmyvideo.ContentUtill;
import com.bumbumapps.videoeditor.listvideoandmyvideo.VideoData;
...
public class MyGIFFragment extends Fragment {
    ...
    private class a extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPreExecute() {
            this.a = new ProgressDialog(MyGIFFragment.this.getActivity(),R.style.CustomDialog);
