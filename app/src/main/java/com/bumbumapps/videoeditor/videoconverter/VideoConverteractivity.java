package com.bumbumapps.videoeditor.videoconverter;
...
public class VideoConverteractivity extends AppCompatActivity implements OnSeekBarChangeListener {
    ...
    private class a {
        ...
        public a() {
            VideoConverteractivity.this.g = new ProgressDialog(VideoConverteractivity.this,R.style.CustomDialog);
            VideoConverteractivity.this.g.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
