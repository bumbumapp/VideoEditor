...
import com.bumbumapps.videoeditor.videotogif.ListVideoAndMyAlbumActivity;
        ...
        if (menuItem.getItemId() == R.id.Delete) {
            ...
            builder.setPositiveButton("Yes", new OnClickListener() {
                @Override public void onClick(final DialogInterface dialogInterface, int i) {
                    ...
                    GIFPreviewActivity.this.e = new ProgressDialog(GIFPreviewActivity.this,R.style.CustomDialog);
                    GIFPreviewActivity.this.e.setCancelable(false);
                    GIFPreviewActivity.this.e.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
                    if (VERSION.SDK_INT <= 19) {


                        GIFPreviewActivity.this.e.setMessage("Please wait...");
                    } else {
                        GIFPreviewActivity.this.e.setMessage(Html.fromHtml("<font color='#ffffff'> Please wait... </font>"));
                    }
            ...
            Uri photoURI = FileProvider.getUriForFile(this, BuildConfig.APPLICATION_ID + ".provider", new File(this.i));
